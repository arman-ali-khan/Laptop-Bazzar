      ...
      <div>
        { product.sold ==='unsold' && <div className={` p-6 rounded-md shadow-md dark:bg-gray-900 dark:text-gray-50 `}>
         <div className="relative">
           ...
           {
             product?.email !== user?.email &&  <div onClick={()=>handleAddToBookmark(product)} title='Add To Bookmark' className="absolute text-base bottom-0 right-0 btn btn-xs rounded-l-full btn-active">
         ...
         {
          product?.email !== user?.email ?  <label
